  ...
  return (
    <div className="bg-[#F5F0E6] py-16 px-4 flex flex-col items-center transition-all duration-500">
      ...
      <div className="flex items-center gap-3 mb-6">
        <FaQuoteLeft className="text-4xl text-[#C34700]" />
        <h2 className="text-3xl md:text-4xl font-bold text-black">People's Voice</h2>
      </div>

      {/* Testimonial Box */}
      <div className="bg-[#C34700] text-white p-6 md:p-10 max-w-3xl min-h-[180px] rounded-[80px_0_80px_0] relative shadow-lg transition-all duration-500">
